...
namespace PAT
{
    //Character Node is the root node of any PAT Character, no input(no parent) and can output to multiple Moveset Node(children)
    public class PAT_CharacterNode : PAT_Node
    {
        ...
        public void Initialize()
        {
            ...
            MonoScript script = AssetDatabase.LoadAssetAtPath<MonoScript>("Assets/PenguinActionToolkit/Core/Scripts/Character/Character.cs");
    ...
    #if UNITY_EDITOR
    [CustomEditor(typeof(PAT_CharacterNode))]
    public class PAT_CharacterNodeInspector : Editor
    {
        // Start is called before the first frame update
        private PAT_CharacterNode node;
