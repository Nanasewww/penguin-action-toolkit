...
namespace PAT
{
    public class PAT_ModifierNode : PAT_Node
    {
        //public List<MonoScript> modifierScripts;
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(PAT_ModifierNode))]
    public class PAT_ModifierNodeInspector : Editor
    {
        // Start is called before the first frame update
        private PAT_ModifierNode node;
