...
namespace PAT
{
    public class TagContainer : MonoBehaviour
    {
        ...
        public List<GamePlayTag> stateTags
        {
            get { return _stateTags; }
        }

        public List<GamePlayTag> locomotionTags
        {
            get { return _locomotionTags; }
        }

        public List<GamePlayTag> effectTags
        {
            get { return _effectTags; }
        }

        public List<GamePlayTag> generalTags
        {
            get { return _generalTags; }
        }

        public List<GamePlayTag> prohibitedTags
        {
            get { return _prohibitedTags; }
        }
